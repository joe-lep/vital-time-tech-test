...
export function DraggingIndexProvider({ children }: DraggingIndexProviderProps) {
  const [currentDraggingIndex, setCurrentDraggingIndex] = useState(DEFAULT_DRAGGING_INDEX);
  ...
  return (
    <draggingIndexContext.Provider value={{currentDraggingIndex, setCurrentDraggingIndex, resetCurrentDraggingIndex}}>
      {children}
